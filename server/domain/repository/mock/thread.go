...
// Source: server/domain/repository/thread.go
...
func (m_2 *MockThreadRepository) ListThreads(ctx context.Context, m query.SQLManager, cursor uint32, limit int) (*model.ThreadList, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockThreadRepository) GetThreadByID(ctx context.Context, m query.SQLManager, id uint32) (*model.Thread, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockThreadRepository) GetThreadByTitle(ctx context.Context, m query.SQLManager, name string) (*model.Thread, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockThreadRepository) InsertThread(ctx context.Context, m query.SQLManager, thead *model.Thread) (uint32, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockThreadRepository) UpdateThread(ctx context.Context, m query.SQLManager, id uint32, thead *model.Thread) error {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockThreadRepository) DeleteThread(ctx context.Context, m query.SQLManager, id uint32) error {
	m_2.ctrl.T.Helper()
