...
// Source: server/domain/repository/comment.go
...
func (m_2 *MockCommentRepository) ListComments(ctx context.Context, m query.SQLManager, threadID uint32, limit int, cursor uint32) (*model.CommentList, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockCommentRepository) GetCommentByID(ctx context.Context, m query.SQLManager, id uint32) (*model.Comment, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockCommentRepository) InsertComment(ctx context.Context, m query.SQLManager, comment *model.Comment) (uint32, error) {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockCommentRepository) UpdateComment(ctx context.Context, m query.SQLManager, id uint32, comment *model.Comment) error {
	m_2.ctrl.T.Helper()
...
func (m_2 *MockCommentRepository) DeleteComment(ctx context.Context, m query.SQLManager, id uint32) error {
	m_2.ctrl.T.Helper()
