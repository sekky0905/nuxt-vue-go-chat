...
// Source: server/domain/service/authentication.go
...
func (m_2 *MockAuthenticationService) Authenticate(ctx context.Context, m query.SQLManager, userName, password string) (bool, *model.User, error) {
	m_2.ctrl.T.Helper()
