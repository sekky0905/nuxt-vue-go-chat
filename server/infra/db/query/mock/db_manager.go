...
// Source: server/infra/db/query/db_manager.go
...
func (m *MockDBManager) Begin() (query.TxManager, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Begin")
	ret0, _ := ret[0].(query.TxManager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Begin mocks base method
func (m *MockBeginner) Begin() (query.TxManager, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Begin")
	ret0, _ := ret[0].(query.TxManager)
	ret1, _ := ret[1].(error)
